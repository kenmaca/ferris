...
$(() => {
  ...
  tw.to($('#ferris .wheel'), FERRIS_SPEED, {rotation: ROTATION, repeat: -1, transformOrigin: '50% 48%', ease: Linear.easeNone});
  ...
  new ScrollMagic.Scene({
    ...
    .to($('#first div[class*="cloud-"]'), 0.3, {opacity: 0, ease: Expo.easeOut}, '-=0.7')
